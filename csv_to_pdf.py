...
Fixed attribute error for logo dimensions.
"""
...
def main():
    ...
    print(f"📏 Logo will be scaled to: 5 inches wide, maintaining aspect ratio")
    ...
    for i, csv_info in enumerate(csv_files, 1):
        ...
        # Generate PDF - pass logo_img only, not width/height
        output_path = create_professional_report(
            csv_info['path'],
            csv_info['event_name'],
            "Form Responses",
            logo_img  # Pass only the image object
        )
